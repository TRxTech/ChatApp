...
<body>
	...
	<div class="container">
        ...
        <div class="info">
            <label>Salary:</label>
            <span>TK<?= number_format($salary, 2) ?></span>
        </div>
        <div class="info">
            <label>Deductions (Absent):</label>
            <span>TK<?= number_format($absent * 30, 2) ?></span>
        </div>
        <div class="info">
            <label>Additions (Completed Tasks):</label>
            <span>TK<?= number_format($completed_tasks * 50, 2) ?></span>
        </div>
        <div class="total">
            Total Amount: TK<?= number_format($salary + ($completed_tasks * 50) - ($absent * 30), 2) ?>
        </div>
    </div>
</body>
